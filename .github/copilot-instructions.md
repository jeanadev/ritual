...
- `scripts/configure-github-account.sh` is the repo-local GitHub identity helper. It prompts for `GITHUB_USERNAME`, `GITHUB_ORG`, and `GITHUB_PROJECT_NUMBER` and writes them to `config/.env`.
